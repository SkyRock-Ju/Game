...
public class MainMenuScreen implements Screen {
    ...
    private void setWidgets() {
        backgroundImage = new Image(new
                Texture(Gdx.files.internal("data/backgroundMN.png")));
//        titleImage = new Image(new
//                Texture(Gdx.files.internal("data/title.png")));
...
//        titleImage.addAction(new SequenceAction(Actions.delay(0.65f),
//                Actions.fadeIn(0.75f)));

        playButton.setSize(256, 128);
        playButton.setPosition(Core.VIRTUAL_WIDTH / 2 -
                playButton.getWidth() / 2, Core.VIRTUAL_HEIGHT / 2 - 100);
        playButton.setColor(1, 1, 1, 0);
        playButton.addAction(new SequenceAction(Actions.delay(0.65f),
                Actions.fadeIn(0.75f)));
...
//        leaderboardsButton.addAction(new SequenceAction(Actions.delay(0.65f),
//                Actions.fadeIn(0.75f)));

        quitButton.setSize(256, 64);
        quitButton.setPosition(Core.VIRTUAL_WIDTH / 2 -
                playButton.getWidth() / 2, Core.VIRTUAL_HEIGHT / 2 - 240);
        quitButton.setColor(1, 1, 1, 0);
        quitButton.addAction(new SequenceAction(Actions.delay(0.65f),
                Actions.fadeIn(0.75f)));
